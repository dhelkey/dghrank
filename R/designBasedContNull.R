designBasedContNull = function(gamma_vec, outcome_vec, pcf_cat_vec, instid_vec){
	...
	#If we are smart, we should be able to get  the vector of points via linear algebra
	for (i in 1:n_cat){
		for (j in 1:n_u){
